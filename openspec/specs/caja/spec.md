# Caja Operaciones Specification

## Purpose

Defines the cash-register (caja) lifecycle: opening, recording manual movements, calculating expected cash by payment method, and closing with variance tracking. Supports per-shift cash control for a butcher shop.
