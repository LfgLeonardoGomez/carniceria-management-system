...
Gestión del catálogo de proveedores de la carnicería. Permite registrar, consultar, modificar y dar de baja proveedores de media res, garantizando aislamiento multi-tenant e integridad de datos. Cada proveedor pertenece a una única empresa y no puede ser compartido.
